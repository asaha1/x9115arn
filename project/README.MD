...
The project has been developed in python and the structure is inspired from the Gadget class by Dr. Menzies. 
...
* Other genetic algorithms such as SA, MWS, GALE could have been used.
